...
def parse_args():
	...
	parser.add_argument('--latent_inpath', type=str, default=None, help='Input path of latent variables to be reconstructed')
	parser.add_argument('--latent_outpath', type=str, default=None, help='Output path of specified dataset to extract latent variables')
	parser.add_argument('--latent_only', type=int, default=0, help='Make only latent reconstructions')
	...
	parser.add_argument('--latent_reconstructions_N', type=int, default=1, help='The number of latent reconstructions from latent variable input')
